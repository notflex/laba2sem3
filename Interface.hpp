...
void interface() {
    ...
    while (switcher) {
        ...
        else if (switcher == 2) {   //  sparce vector - разряженный вектор, что-то вроде массива выделяюещий например 100000 значений, а занято всего три значения
        ...
        else if (switcher == 3) { // найти наиболее часто встречающуюся подпоследовательность элементов(символов)
